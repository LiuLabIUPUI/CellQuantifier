...
def plot_stiffness1(
    ...
    if not df.empty:
        ...
        dfp5 = df[ df['exp_label']=='Ctrl-24h-glass' ].drop_duplicates('frame')
        dfp5['avg_foci_num'] = dfp5['avg_foci_num'] / dfp5['avg_foci_num'].max()
        # dfp5['avg_foci_num'] = (dfp5['avg_foci_num'] - dfp5['avg_foci_num'].min()) \
        #             / (dfp5['avg_foci_num'].max() - dfp5['avg_foci_num'].min())
        dfp5 = dfp5[ ['frame',
            'avg_foci_num', 'avg_foci_peaksum', 'avg_foci_areasum',
            'avg_foci_pkareasum', 'avg_foci_peakmean', 'avg_foci_areamean',
            'exp_label'] ]
        dfp5 = dfp5.sort_values(by='frame')
        dfp5.round(6).to_csv('/home/linhua/Desktop/dfp5.csv', index=False)
    ...
    y_cols = [
            'avg_foci_num', 'avg_foci_num', 'avg_foci_num', 'avg_foci_num', 'avg_foci_num',
    ...
    legends = [
            'IR-24h-0.2kPa', 'IR-24h-2kPa', 'IR-24h-12kPa', 'IR-24h-glass', 'Ctr-24h-glass',
    ...
    ylabels = [
            'foci num', 'foci num', 'foci num', 'foci num', 'foci num',
