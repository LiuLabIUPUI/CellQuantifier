...
def fig_quick_rna_5(merged_blobs_df, norm_row_props,
	...
	count_df = merged_blobs_df.groupby(['label','cell_type', 'prefix',\
										'region_type', 'exp_label'\
										]).size().reset_index(name="count")

	# count_df.to_csv('/home/clayton/Desktop/data-analysis/200521_HLA-DMB-final-analysis/200521_HLA-DMB-fig3-count-df.csv')

	# """
	# ~~~~~~~~~~~Copy number group bar chart~~~~~~~~~~~~~~
	# """

	data_col = 'count'; cat_cols = ['cell_type', 'exp_label']
	...
	# count_df_stat.to_csv('/home/clayton/Desktop/data-analysis/200521_HLA-DMB-final-analysis/200521_HLA-DMB-fig3-count-df-stat.csv')
