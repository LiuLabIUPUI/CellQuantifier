...
class Config():
	...
	def __init__(self, config):
		...
		self.MASK_SIG_BOUNDARY = config['Phys boundary_mask sig']
		self.MASK_THRES_BOUNDARY = config['Phys boundary_mask thres_rel']
		self.DIST253BP1_MASK_NAME = ''
		self.MASK_SIG_53BP1 = config['Phys 53bp1_mask sig']
		self.MASK_THRES_53BP1 = config['Phys 53bp1_mask thres_rel']
